...
(client/src/components/page-header.tsx); navigation = icon rail + flyout
(client/src/components/app-nav.tsx — sections Home / Brief / Monitor / Reach /
Clients, Workspace gear at the bottom; add new pages to its section lists). Rules in docs/BRAND.md
